...
In order to request that data from your repositories be removed from The Stack, we ask that you first fill out the [following form](https://forms.gle/6o2A6h3YcAuGYxtm7) with your GitHub username and the email address associated with your git activity. We will then get back to you with instructions to verify your GitHub account. At the moment, we will invite you to a private repository on the BigCode organization and ask you to open an issue with the topic “remove my code from The Stack”. After verification, we will remove you from the repository and flag all public repositories owned by your Github account for removal in the next dataset release cycle. We are looking into better ways to automate this verification process. 
